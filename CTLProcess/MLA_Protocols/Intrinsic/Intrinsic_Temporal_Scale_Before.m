function Intrinsic_Temporal_Scale_Before(MATPATH, FIGPATH)
%% Parameter setting
...
for dIndex = 1:length(devType)
    ...
    load(fullfile(strrep(FIGPATH, regexp(FIGPATH, "\\Intrinsic_Temporal_Scale_Before\\", "match"), "\Noise-ITI-2s\"), "sigRes.mat"));
