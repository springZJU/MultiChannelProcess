function BF_CSD_Nice(MATPATH, FIGPATH)
...
for mIndex = 1 : length(CSD_Methods)
    ...
    FIGNAME = strcat(FIGPATH, "\", CSD_Method);
...
% save(fullfile(FIGPATH, "MUARes.mat"), "MUA", "trialsWAVE", "-mat");

% spikeRes = sNoise_RNP(MATPATH, strcat(FIGPATH, dateStr));
% save(fullfile(FIGPATH, "spikeRes.mat"), "spikeRes", "-mat");
